...
- [Specialized Fields](#specialized-fields)
  ...
  - [FPGA Programming](#2-fpga-programming)
  - [Compilers & Interpreters](#3-compilers--interpreters)
  - [Operating Systems Development](#4-operating-systems-development)
  - [GPGPU & Parallel Computing](#5-gpgpu--parallel-computing)
  - [Graphics Programming](#6-graphics-programming)
  - [Game Engine Development](#7-game-engine-development)
  - [Network Systems Programming](#8-network-systems-programming)
